...
latex_documents = [
    (master_doc, 'camacq.tex', u'camacq Documentation',
     u'Martin Hjelmare', 'manual'),
]
...
man_pages = [
    (master_doc, 'camacq', u'camacq Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'camacq', u'camacq Documentation',
     author, 'camacq', 'One line description of project.',
     'Miscellaneous'),
]
